...
const reasons = [
  {
    ...
    desc: "Every strategy is backed by data and focused on measurable outcomes.",
    icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",
  },
  {
    title: "Creative + Analytical Mind",
    desc: "The perfect blend of artistic creativity and strategic thinking.",
    icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
  },
  {
    title: "On-Time Delivery",
    desc: "Deadlines are sacred. Your projects are delivered on schedule, every time.",
    icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",
  },
  {
    title: "Transparent Communication",
    desc: "Clear updates, honest feedback, and open collaboration throughout.",
