...
const steps = [
  {
    ...
    desc: "Deep-dive into your business, competitors, and market to uncover opportunities.",
    icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z",
  },
  {
    num: "02",
    title: "Strategy & Planning",
    desc: "Craft a data-driven roadmap aligned with your goals and budget.",
    icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2",
  },
  {
    num: "03",
    title: "Design & Development",
    desc: "Build stunning creatives and high-performance websites that convert.",
    icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4",
  },
  {
    num: "04",
    title: "Launch & Optimize",
    desc: "Go live, track KPIs, and continuously optimize for maximum ROI.",
          ...
          {steps.map((s, i) => (
            <ScrollReveal key={s.num} delay={i * 0.15}>
              ...
              >
                ...
                <span className="mt-3 block font-heading text-3xl font-bold text-muted-foreground/20">
                  {s.num}
                </span>
